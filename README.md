...
1. **Managed package**: install the current release (**0.8.0.1**):
   - Sandbox & scratch orgs: <https://test.salesforce.com/packaging/installPackage.apexp?p0=04tRQ000000AhEzYAK>
   - Production & Developer Edition: <https://login.salesforce.com/packaging/installPackage.apexp?p0=04tRQ000000AhEzYAK>
