...
1. **Managed package**: install the current release (**0.9.0.1**):
   - Sandbox & scratch orgs: <https://test.salesforce.com/packaging/installPackage.apexp?p0=04tRQ000000Aj5VYAS>
   - Production & Developer Edition: <https://login.salesforce.com/packaging/installPackage.apexp?p0=04tRQ000000Aj5VYAS>
